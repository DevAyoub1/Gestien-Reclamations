...
export default function AddObservation() {
  ...
  const handleSubmit = async(event) => {
    ...
    try {
       await Axios.post("/api/observations",values)
    alert('Observation added successfully!')
    navigate('/UserObservation')
    } catch (error) {
  ...
  return (
  <> <br /><br />
   <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}><Textarea aria-label="minimum height" minRows={8} name='Description' placeholder="" /><br /><span style={{color:"red" }}>{error}</span><br /><br />
