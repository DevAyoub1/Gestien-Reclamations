...
await Axios.put(`/api/clients/${user.id}`,{
  ...
  return (
    ...
    >
      <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
       ...
       <div style={{display:"-ms-inline-grid",margin:"5px"}} ><TextField level="body-sm" sx={{ maxWidth: '10ch' }} type='text' onChange={(e)=>setNom(e.target.value)} value={nom} style={{margin:"5px"}} label="nom"/><TextField level="body-sm" sx={{ maxWidth: '10ch' }} type='text' onChange={(e)=>setprenom(e.target.value)} style={{margin:"5px"}} value={prenom} label="prenom"/></div> 
        <TextField level="body-sm" sx={{ maxWidth: '34ch' }} type='text'onChange={(e)=>setemail(e.target.value)} value={email} label="email"  style={{marginBottom:"5px"}}/>
        
       
        <TextField level="body-sm" sx={{ maxWidth: '34ch' }} type='text' onChange={(e)=>settelephone(e.target.value)} value={telephone} label="téléphone" style={{marginBottom:"5px"}}/>
       
        <TextField level="body-sm" sx={{ maxWidth: '34ch' }} type='text' onChange={(e)=>setadresse(e.target.value)} value={adresse} label="adresse"/>
        <Box
          sx={{
            display: 'flex',
            gap: 2,
